...
<body id="page-top">
    ...
    <div id="wrapper"> <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="http://localhost/PelanggaranSiswa/operator/dataSiswa">
                    <i class="fas fa-fw fa-user-tie"></i>
                    <span>Data Siswa</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link pb-0" href="http://localhost/PelanggaranSiswa/operator/DataGuru">
                    <i class="fas fa-fw fa-user-tie"></i>
                    <span>Data Guru</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link pb-0" href="http://localhost/PelanggaranSiswa/operator/DataLaporan">
                    <i class="fas fa-fw fa-user-tie"></i>
