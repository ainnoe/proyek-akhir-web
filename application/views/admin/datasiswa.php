                ...
                <tbody>
                    ...
                    foreach ($DataSiswa as $ds) : ?>
                        <tr>
                            ...
                            <td><?= $ds->kelas; ?></td>
                            <td width="20px">
                                <?php echo anchor('admin/update/' . $ds->nis, '<div class="btn btn-sm btn-primary">Edit<i class="fa fa-edit"></i></div>') ?>
                                <?php echo anchor('admin/deletedataSiswa/' . $ds->nis, '<div class="btn btn-sm btn-danger">Delete<i class="fa fa-delete"></i></div>') ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
    ...
    <div class="modal fade" id="adddatasiswaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('admin/add_Siswa'); ?> ">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kelas" class="form-control" id="kelas">
                                ...
                                ?>
                                <option value=<?= $ds->id_kelas; ?>><?= $ds->kelas; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
