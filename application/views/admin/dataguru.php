                ...
                <tbody>
                    ...
                    foreach ($DataGuru as $dg) : ?>
                        <tr>
                            ...
                            <td><?= $dg->jabatan; ?></td>
                            <td width="20px">
                                <?php echo anchor('admin/updateGuru/' . $dg->nip, '<div class="btn btn-sm btn-primary">Edit<i class="fa fa-edit"></i></div>') ?>
                                <?php echo anchor('admin/deletedataGuru/' . $dg->nip, '<div class="btn btn-sm btn-danger">Delete<i class="fa fa-delete"></i></div>') ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
